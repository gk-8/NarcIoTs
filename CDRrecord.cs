...
namespace telcodatagen
{
    ...
    public class CDRrecord
    {
        ...
        static string[] columns = {"RecordType","SystemIdentity","FileNum","SwitchNum","CallingNum","CallingIMSI",
                            ...
                            "CityFrom", "CountryFrom", "LatitudeFrom", "LongitudeFrom", "CityTo", "CountryTo", "LatitudeTo", "LongitudeTo"};
        ...
        static string[] CityList = { "Medellin", "La Catedral" ,"Miami", "New York", "Los Angeles", "Barcelona", "Ciudad Juarez", "Guadalajara", "Albuquerque", "Sucre" };
        static string[] CountryList = { "Colombia", "Colombia", "United States", "United States", "United States", "Spain", "Mexico", "Mexico", "United States", "Bolivia" };
        static string[] LatitudeList = { "6.230833", "6.117778", "25.775278", "40.7127", "34.05", "41.3825", "31.739444", "20.666667", "35.110833", "-19.05" };
        static string[] LongitudeList = { "-75.590556", "-75.585", "-80.208889", "-74.0059", "-118.25", "2.176944", "-106.486944", "-103.35", "-106.61", "-65.25" };
        ...
        public void _init()
        {
            ...
            idx = coin.Next(0, CityList.Length);
            data.Add("CityFrom", CityList[idx]);
            data.Add("CountryFrom", CountryList[idx]);
            data.Add("LatitudeFrom", LatitudeList[idx]);
            data.Add("LongitudeFrom", LongitudeList[idx]);
            this.CityFrom = CityList[idx];
            this.CountryFrom = CountryList[idx];
            this.LatitudeFrom = LatitudeList[idx];
            this.LongitudeFrom = LongitudeList[idx];

            idx = coin.Next(0, CityList.Length);
            data.Add("CityTo", CityList[idx]);
            data.Add("CountryTo", CountryList[idx]);
            data.Add("LatitudeTo", LatitudeList[idx]);
            data.Add("LongitudeTo", LongitudeList[idx]);
            this.CityTo = CityList[idx];
            this.CountryTo = CountryList[idx];
            this.LatitudeTo = LatitudeList[idx];
            this.LongitudeTo = LongitudeList[idx];
        }
